...
-- Write SQL query here
SELECT countries.name FROM cities JOIN countries on cities.countrycode = countries.code
...
-- Write SQL query here
SELECT cities.name FROM cities JOIN countries on cities.id = countries.capital
...
-- ANSWER: Santa Monica -> Because she is going to a city to increase the population by 1 to 91,085